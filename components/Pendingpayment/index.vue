<template>
	...
	<view class="Pendingpayment">
		<scroll-view scroll-y="true" style="width: 100%;height: 800px;" @scrolltolower="scrolltolower">
		<view class="Pendingpayment-box" v-for="item in list" :key="item.id">
			...
			<view class="Pendingpayment-btn-box">
				...
				<view class="unorder">
					<view @click="unorder(item.orderNum)">取消订单</view>
				</view>
			</view>
		</view>
		</scroll-view>
...
<script>
	export default {
		...
		methods:{
			...
			unorder(id){
				uni.navigateTo({
					url:"/pages/my/unorder/unorder?id="+id,
